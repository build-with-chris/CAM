        ...
        <Card>
          {submitted ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-700">{site.kontakt.success}</p>
            </div>
          ) : (
            <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2">
                  {site.kontakt.fields.name} *
                </label>
                <input
                  type="text"
                  id="name"
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 border rounded transition-colors resize-none focus:outline-none focus:ring-2 ${
                    errors.message ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-primary-700 focus:border-primary-700'
                  }`}
              ...
              <div>
                <div className="flex items-start">
                  ...
                  <label htmlFor="privacy" className="ml-2 text-sm text-gray-700">
                    {site.kontakt.fields.datenschutz} <Link href="/datenschutz" className="text-primary-900 hover:text-primary-700 underline">Datenschutzhinweise</Link> *
                  </label>
                </div>
                {errors.privacy && (
                  <p id="privacy-error" className="mt-2 text-sm text-red-600" role="alert">
                    {errors.privacy}
                  </p>
                )}
              </div>
